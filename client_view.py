...
class ClientView(ctk.CTk):
    def __init__(self):
        ...
        # Configuração da janela principal com tema escuro
        self.title("Gestão de Clientes - Card View")
        self.geometry("1200x800")
        self.resizable(False, False)
        self.configure(bg="#2C3E50")  # Fundo escuro

        # Variável para armazenar as tags originais de cada linha
        self.row_tags = {}
        ...
        # Área dos Cards (usando Canvas para permitir scroll)
